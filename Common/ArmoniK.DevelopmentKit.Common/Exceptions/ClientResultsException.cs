...
namespace ArmoniK.DevelopmentKit.Common.Exceptions
{
  ...
  public class ClientResultsException : Exception
  {
    ...
    /// <param name="message">the message in exception</param>
    /// <param name="taskIds">The list of taskId</param>
    public ClientResultsException(string message, params string[] taskIds) : base(message)
    {
      TaskIds = taskIds;
    ...
    public ClientResultsException(string message, IEnumerable<string> taskIds) : base(message)
    {
      TaskIds = taskIds;
    }
